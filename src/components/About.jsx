    ...
    <div className="w-full md:h-screen p-2 flex items-center py-16">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <p className="uppercase text-2xl md:text-3xl mb-4 tracking-widest text-[#F33535] ">
            O nás
          </p>
          <p className="py-2 text-gray-600 text-lg md:text-2xl md:my-6">
          ...
          <p className="py-2 text-lg text-gray-600 md:text-2xl">
            Zároveň sa snažíme ponúkať jedinečné zážitky a zabezpečiť, aby
            vozidlá boli nielen kultúrnymi artefaktmi, ale aj funkčnými strojmi
            na cestách. Sme hrdí na našu prácu a veríme, že vás zaujmú naše
            služby.
          </p>
        </div>
